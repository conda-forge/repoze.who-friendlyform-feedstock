About repoze.who-friendlyform-feedstock
=======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/repoze.who-friendlyform-feedstock/blob/main/LICENSE.txt)
...
Development: https://pypi.org/project/repoze.who-friendlyform/

Documentation: http://code.gustavonarea.net/repoze.who-friendlyform/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8060&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/repoze.who-friendlyform-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `repoze.who-friendlyform` can be installed with `conda`:
...
```
mamba install repoze.who-friendlyform
```

It is possible to list all of the versions of `repoze.who-friendlyform` available on your platform with `conda`:
...
```
mamba search repoze.who-friendlyform --channel conda-forge
```
...
mamba repoquery search repoze.who-friendlyform --channel conda-forge

# List packages depending on `repoze.who-friendlyform`:
mamba repoquery whoneeds repoze.who-friendlyform --channel conda-forge

# List dependencies of `repoze.who-friendlyform`:
mamba repoquery depends repoze.who-friendlyform --channel conda-forge
```
